...
import { ArrowRight, Search, FileText, Link2, Code, BarChart3, Users, Check, MapPin, Zap, TrendingUp, Crown, Scissors, Car, Dumbbell, Camera } from 'lucide-react';
import Link from 'next/link';
import Image from 'next/image';
import type { Metadata } from 'next';

export const metadata: Metadata = {
  title: 'SEO voor B2C dienstverlening | Meer klanten via Google',
  description: 'Als B2C dienstverlener wil je gevonden worden door consumenten. Vizibly helpt met lokale SEO die leidt tot meer klanten.',
  openGraph: {
    title: 'SEO voor B2C dienstverlening | Meer klanten via Google',
    description: 'Als B2C dienstverlener wil je gevonden worden door consumenten. Vizibly helpt met lokale SEO die leidt tot meer klanten.',
    url: 'https://vizibly.nl/seo-voor-b2c-dienstverlening/',
    siteName: 'Vizibly',
    locale: 'nl_NL',
    type: 'website',
  },
...
export default function SeoVoorB2CPage() {
  const faqData = [
    {
      question: 'Waarom is lokale SEO zo belangrijk voor B2C dienstverleners?',
      answer: 'Consumenten zoeken vaak lokaal: "kapper in de buurt", "rijschool [stad]" of "fotograaf [regio]". Door goed te scoren in lokale zoekresultaten en Google Maps, bereik je potentiele klanten precies wanneer ze op zoek zijn naar jouw dienst in jouw werkgebied.'
    },
    {
      question: 'Hoe snel zie ik resultaten met SEO?',
      answer: 'Voor lokale B2C diensten zien we vaak snellere resultaten dan gemiddeld, omdat de online concurrentie vaak beperkt is. Eerste verbeteringen zijn meestal na 2-4 maanden zichtbaar. Het voordeel: eenmaal goed gepositioneerd, profiteer je duurzaam zonder doorlopende advertentiekosten.'
    },
    {
      question: 'Hoe belangrijk zijn Google reviews voor mijn B2C business?',
      answer: 'Zeer belangrijk. Reviews beinvloeden niet alleen je lokale rankings, maar ook het beslissingsproces van potentiele klanten. We helpen je met een strategie om systematisch meer reviews te verzamelen en deze te benutten in je marketingstrategie.'
    },
    {
      question: 'Kunnen jullie ook helpen als ik meerdere locaties heb?',
      answer: 'Ja, we hebben ervaring met multi-location SEO. Voor elke vestiging of werkgebied creeren we een aparte strategie met eigen Google Mijn Bedrijf profiel en lokale content. Zo is elke locatie optimaal vindbaar.'
    },
    {
      question: 'Wat onderscheidt SEO voor B2C van andere branches?',
      answer: 'B2C SEO focust sterk op lokale vindbaarheid, snelle conversie en emotionele triggers. Consumenten beslissen sneller dan B2B beslissers, dus content en website moeten direct overtuigen. Reviews en visuele elementen spelen een grotere rol.'
    }
  ];
  ...
  const structuredData = {
    ...
    "@graph": [
      {
        "@type": "Service",
        "@id": "https://vizibly.nl/seo-voor-b2c-dienstverlening/#service",
        "name": "SEO voor B2C Dienstverlening",
        "description": "Professionele zoekmachine optimalisatie voor lokale B2C dienstverleners",
        "provider": {
          "@type": "Organization",
      ...
      {
        "@type": "FAQPage",
        "@id": "https://vizibly.nl/seo-voor-b2c-dienstverlening/#faq",
  ...
  const services = [
    ...
    },
    {
      icon: FileText,
      title: 'SEO teksten',
      description: 'Teksten die scoren en overtuigen. Dienstpaginas die je expertise tonen, lokale content die je verbindt met je werkgebied, en blogs die potentiele klanten inspireren. Content die bezoekers omzet in klanten.',
      link: '/seo-copy',
    ...
    },
    {
      icon: Link2,
      title: 'Linkbuilding',
      description: 'Lokale autoriteit opbouwen via backlinks van regionale bronnen, brancheverenigingen en samenwerkingspartners. Kwalitatieve links die je geloofwaardigheid en rankings in je werkgebied versterken.',
      link: '/linkbuilding',
    ...
    },
    {
      ...
      description: 'Een snelle, aantrekkelijke website die direct overtuigt. Consumenten beslissen snel, dus eerste indruk telt. We zorgen voor optimale prestaties, mobiele ervaring en een design dat past bij je merk.',
    ...
    },
    {
      icon: MapPin,
      title: 'Lokale SEO',
      description: 'Verschijn in Google Maps en lokale zoekresultaten. We optimaliseren je Google Mijn Bedrijf profiel, verzamelen reviews en bouwen aan je lokale autoriteit. Essentieel voor iedere lokale dienstverlener.',
      link: '/local-seo',
    ...
    },
    {
      ...
      description: 'We monitoren je rankings, verkeer en contactaanvragen. Maandelijks ontvang je een heldere rapportage met concrete resultaten en verbeterpunten.',
      link: null,
      linkText: null
    }
  ];
  ...
  const specialisaties = [
    { icon: Scissors, title: 'Kappers & Beauty', description: 'Salons en schoonheidsspecialisten' },
    { icon: Car, title: 'Rijscholen', description: 'Autorijscholen en instructeurs' },
    { icon: Dumbbell, title: 'Fitness & Sport', description: 'Personal trainers en sportscholen' },
    { icon: Camera, title: 'Fotografen', description: 'Bruiloftfotografie en portret' }
  ];
  ...
  const pricingPackages = [
    {
      ...
      price: '€500',
      period: '/maand',
      description: 'Voor B2C dienstverleners die starten met SEO',
      features: [
        'Technische SEO audit & fixes',
        'Google Mijn Bedrijf optimalisatie',
        'Keyword research voor jouw dienst',
    ...
    },
    {
      ...
      price: '€1000',
      period: '/maand',
      description: 'Voor groeiende B2C businesses',
      features: [
        'Alles uit Basis +',
        'Lokale contentstrategie',
    ...
    },
    {
      ...
      price: '€2000',
      period: '/maand',
      description: 'Voor B2C marktleiders die willen domineren',
      features: [
        'Alles uit Standaard +',
    ...
    <>
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
            <div>
              <div className="mb-6 inline-flex items-center gap-2 border-4 border-black bg-accent px-4 py-2">
                ...
                <span className="text-base font-bold uppercase">B2C SEO</span>
              </div>
              ...
              <h1 className="mb-8 text-brutalist-hero leading-none text-black">
                ...
                <span className="relative inline-block">
                  ...
                  <span className="relative">B2C</span>
                </span>
                : bereik lokale klanten
              </h1>
            ...
            <div className="relative">
              <div className="relative border-4 border-black bg-accent p-2" style={{ boxShadow: '12px 12px 0 0 #000000, 0 25px 60px rgba(0, 0, 0, 0.3)' }}>
                <Image
                src="/images/b2c-seo.webp"
                  alt="SEO voor B2C dienstverlening"
                  width={640}
                  height={427}
        ...
        <div className="relative mx-auto max-w-screen-2xl px-6">
          <div className="grid grid-cols-2 gap-8 lg:grid-cols-4">
            {[
              ...
              { value: '25+', label: 'B2C klanten geholpen' },
        ...
        <div className="mx-auto max-w-screen-2xl px-6">
          <div className="mb-16">
            <p className="mb-6 text-base font-semibold uppercase tracking-widest text-black/60 lg:text-lg">
              VOOR ALLE LOKALE DIENSTVERLENERS
            </p>
            <h2 className="mb-8 text-brutalist-h1 text-black">
              SEO die past bij jouw vak
            </h2>
          </div>
        ...
        <div className="mx-auto max-w-screen-2xl px-6">
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-start">
            <div>
              ...
              <h2 className="mb-8 text-brutalist-h1 text-black">
                Word gevonden wanneer het ertoe doet
              </h2>
      ...
      <section className="relative border-b-4 border-black bg-[#fafaf8] py-32 lg:py-40">
        <div className="mx-auto max-w-screen-2xl px-6">
          <div className="mb-16">
            <p className="mb-6 text-base font-semibold uppercase tracking-widest text-black/60 lg:text-lg">
              ONZE B2C SEO DIENSTEN
            </p>
            <h2 className="mb-8 text-brutalist-h1 text-black">
              Complete SEO voor lokale dienstverleners
            </h2>
            <p className="max-w-3xl text-base font-bold text-black/80 lg:text-lg xl:text-xl">
              Van Google Mijn Bedrijf tot lokale content en review-strategieen. We pakken alles aan wat nodig is om jouw B2C business lokaal zichtbaar te maken.
            </p>
          </div>
      ...
      <section className="relative border-b-4 border-black bg-accent py-32 lg:py-40">
        <div className="mx-auto max-w-screen-2xl px-6">
          <div className="mb-16 text-center">
            ...
            <h2 className="mb-8 text-brutalist-h1 text-black">
              Pakketten voor B2C dienstverleners
            </h2>
            <p className="mx-auto max-w-3xl text-base font-bold text-black/80 lg:text-lg xl:text-xl">
              Kies het pakket dat past bij jouw business. Alle pakketten zijn flexibel en maandelijks opzegbaar.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-screen-2xl px-6">
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
            <div>
              ...
              <h2 className="mb-8 text-brutalist-h1 text-black">
                We begrijpen lokale dienstverlening
              </h2>
              <div className="h-1 w-32 bg-accent mb-8"></div>
              <p className="mb-8 text-base font-bold text-black/80 lg:text-lg xl:text-xl">
                Bij Vizibly werken we met lokale ondernemers die serieus zijn over het bereiken van meer klanten. We begrijpen de uitdagingen: beperkt budget, lokale concurrentie, en de noodzaak om snel resultaat te zien.
              </p>
              <p className="mb-8 text-base font-bold text-black/80 lg:text-lg xl:text-xl">
                We focussen op wat telt: meer klanten uit jouw werkgebied. Geen complexe rapportages over vanity metrics, maar concrete resultaten die je business laten groeien.
              </p>
              <Button size="lg" asChild className="text-base px-8 py-5">
                <Link href="/contact">
                  START EEN GESPREK
      ...
      <FinalCTA
        ...
        heading="Laat je business groeien met lokale SEO"
      />
