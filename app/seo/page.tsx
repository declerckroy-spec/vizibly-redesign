        ...
        <div className="relative mx-auto max-w-screen-2xl px-6">
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
            ...
            <div className="flex items-center justify-center border-4 border-black bg-[#fafaf8] p-4 lg:p-6" style={{ boxShadow: '12px 12px 0 0 #CCFF00, 0 25px 60px rgba(204, 255, 0, 0.4)' }}>
              <SEOAuditIllustration className="w-full h-auto max-w-lg text-black grayscale hover:grayscale-0 transition-all duration-[400ms] ease-[cubic-bezier(0.4,0,0.2,1)]" />
            </div>
          </div>
        </div>
      </section>
