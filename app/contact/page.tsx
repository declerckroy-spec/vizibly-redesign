...
export default function ContactPage() {
  ...
  return (
    <>
      ...
      {/* Contact Section */}
      <section className="relative border-y-4 border-black bg-[#fafaf8] py-32 lg:py-40">
        <div className="mx-auto max-w-screen-2xl px-6">
          <div className="grid gap-16 lg:grid-cols-2 lg:gap-24">
            ...
            <div>
              ...
              <div className="grid gap-6">
                ...
                >
                  ...
                  <div>
                    <p className="text-sm font-semibold uppercase tracking-widest text-black/60">Bel direct</p>
                ...
                >
                  ...
                  <div>
                    <p className="text-sm font-semibold uppercase tracking-widest text-black/60">Mail me</p>
              ...
              {/* Address Card */}
              <div className="mt-12 border-4 border-black p-8" style={{ boxShadow: '8px 8px 0 0 #000000, 0 20px 50px rgba(0, 0, 0, 0.25)' }}>
            ...
            {/* Contact Form */}
            <div>
              <div className="border-4 border-black bg-white p-8 lg:p-12" style={{ boxShadow: '12px 12px 0 0 #CCFF00, 0 25px 60px rgba(204, 255, 0, 0.4)' }}>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    <label htmlFor="naam" className="mb-2 block text-sm font-semibold uppercase tracking-widest text-black">
                      Naam *
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label htmlFor="email" className="mb-2 block text-sm font-semibold uppercase tracking-widest text-black">
                      E-mail *
                    </label>
                    <input
                      type="email"
                  ...
                  <div className="grid gap-6 md:grid-cols-2">
                    <div>
                      <label htmlFor="telefoon" className="mb-2 block text-sm font-semibold uppercase tracking-widest text-black">
                        Telefoon
                      </label>
                      <input
                        type="tel"
                    ...
                    <div>
                      <label htmlFor="website" className="mb-2 block text-sm font-semibold uppercase tracking-widest text-black">
                        Website
                      </label>
                      <input
                        type="url"
                  ...
                  <div>
                    <label htmlFor="bericht" className="mb-2 block text-sm font-semibold uppercase tracking-widest text-black">
                      Bericht *
                    </label>
                    <textarea
                      id="bericht"
