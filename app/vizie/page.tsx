        ...
        <div className="mx-auto max-w-screen-2xl px-6">
          <div className="grid gap-12 lg:grid-cols-3 lg:gap-16">
            ...
            <div className="lg:col-span-1">
              {/* Featured Articles */}
              <div className="mb-8 border-4 border-black bg-black p-6" style={{ boxShadow: '8px 8px 0 0 #CCFF00' }}>
              ...
              {/* CTA Box */}
              <div className="border-4 border-black bg-accent p-6" style={{ boxShadow: '8px 8px 0 0 #000000' }}>
