...
import { ArrowRight, ArrowLeft, User, Clock, Phone, Mail, MapPin } from 'lucide-react';
        ...
        <div className="mx-auto max-w-screen-2xl px-6">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mb-10 text-lg font-bold text-black/80 lg:text-xl">
              Nu je de basis kent, is het tijd om actie te ondernemen. Wij helpen je graag met een SEO-strategie die echt werkt.
            </p>
