...
import { ArrowRight, Search, FileText, Link2, Code, BarChart3, Wrench, Check, MapPin, Zap, TrendingUp, Crown, Phone, Flame } from 'lucide-react';
import Link from 'next/link';
import Image from 'next/image';
import type { Metadata } from 'next';

export const metadata: Metadata = {
  title: 'SEO voor loodgieters | Meer klanten via Google',
  description: 'Als loodgieter of installatiebedrijf wil je gevonden worden wanneer mensen je nodig hebben. Vizibly helpt met SEO die leidt tot meer opdrachten.',
  openGraph: {
    title: 'SEO voor loodgieters | Meer klanten via Google',
    description: 'Als loodgieter of installatiebedrijf wil je gevonden worden wanneer mensen je nodig hebben. Vizibly helpt met SEO die leidt tot meer opdrachten.',
    url: 'https://vizibly.nl/seo-voor-loodgieters-en-installatiebedrijven/',
    siteName: 'Vizibly',
    locale: 'nl_NL',
    type: 'website',
  },
...
export default function SeoVoorLoodgietersPage() {
  const faqData = [
    {
      question: 'Hoe snel kan ik resultaten verwachten met SEO als loodgieter?',
      answer: 'Voor lokale dienstverleners zoals loodgieters zien we vaak snellere resultaten dan gemiddeld, omdat de online concurrentie beperkt is. Eerste verbeteringen zijn vaak al na 2-3 maanden zichtbaar, met significante groei na 4-6 maanden. Het voordeel: eenmaal goed gepositioneerd, blijf je duurzaam profiteren zonder doorlopende advertentiekosten.'
    },
    {
    ...
    },
    {
      ...
      answer: 'Zeer belangrijk. Google Reviews hebben direct invloed op je lokale rankings en verschijnen prominent in de zoekresultaten. Bovendien beïnvloeden ze de keuze van potentiële klanten. We helpen je met een strategie om systematisch meer reviews te verzamelen en deze te verwerken in je SEO-strategie.'
    },
    {
      question: 'Werkt SEO ook voor specialistische installatiewerkzaamheden?',
      answer: 'Absoluut. Juist voor specialisaties als warmtepompen, zonneboilers, of industriële installaties is SEO effectief. De concurrentie is lager en de zoekintentie is vaak heel specifiek. We helpen je positioneren op de juiste long-tail zoektermen voor jouw specialisatie.'
    },
    {
      question: 'Moet mijn website compleet vernieuwd worden voor goede SEO?',
      answer: 'Niet per se. We starten altijd met een audit om te bepalen wat nodig is. Soms volstaat optimalisatie van de bestaande site, soms is een nieuwe site verstandiger. We adviseren eerlijk wat de beste investering is voor jouw situatie en budget.'
    }
  ];
  ...
  const structuredData = {
    ...
    "@graph": [
      {
        "@type": "Service",
        "@id": "https://vizibly.nl/seo-voor-loodgieters-en-installatiebedrijven/#service",
        "name": "SEO voor Loodgieters en Installatiebedrijven",
        "description": "Professionele zoekmachine optimalisatie voor loodgieters, installateurs en technische dienstverleners",
        "provider": {
          "@type": "Organization",
      ...
      {
        "@type": "FAQPage",
        "@id": "https://vizibly.nl/seo-voor-loodgieters-en-installatiebedrijven/#faq",
  ...
  const services = [
    ...
    },
    {
      icon: FileText,
      title: 'SEO teksten',
      description: 'Teksten die scoren én overtuigen. Dienstpagina\'s voor al je werkzaamheden, van lekkages tot complete badkamerinstallaties. Content die jouw expertise toont en bezoekers aanzet tot bellen of een offerteaanvraag indienen.',
      link: '/seo-copy',
    ...
    },
    {
      icon: Link2,
      title: 'Linkbuilding',
      description: 'Lokale autoriteit opbouwen via backlinks van relevante bronnen. Denk aan lokale bedrijvengidsen, brancheverenigingen en regionale samenwerkingspartners. Kwalitatieve links die je rankings en geloofwaardigheid versterken.',
      link: '/linkbuilding',
    ...
    },
    {
      ...
      description: 'Een snelle, mobiel-vriendelijke website is cruciaal. Veel klanten zoeken een loodgieter op hun telefoon wanneer ze een probleem hebben. We zorgen voor optimale laadtijd en een gebruiksvriendelijke ervaring die bezoekers direct laat bellen.',
    ...
    },
    {
      icon: MapPin,
      title: 'Lokale SEO',
      description: 'Verschijn in Google Maps en de lokale zoekresultaten. We optimaliseren je Google Mijn Bedrijf profiel, verzamelen reviews en bouwen aan je lokale autoriteit. Essentieel voor loodgieters die in een specifiek werkgebied opereren.',
      link: '/local-seo',
    ...
    },
    {
      ...
      description: 'We volgen je rankings, websiteverkeer en telefoontjes. Maandelijks ontvang je een heldere rapportage met concrete resultaten. Op basis van data optimaliseren we continu je strategie voor maximaal rendement.',
      link: null,
      linkText: null
    }
  ];
  ...
  const specialisaties = [
    { icon: Wrench, title: 'Loodgieters', description: 'Lekkages, verstoppingen, sanitair' },
    { icon: Flame, title: 'CV-monteurs', description: 'Ketelinstallatie en onderhoud' },
    { icon: Zap, title: 'Elektriciens', description: 'Installaties en storingen' },
    { icon: Phone, title: 'Spoed diensten', description: '24-uurs bereikbaarheid' }
  ];
  ...
  const pricingPackages = [
    {
      ...
      price: '€500',
      period: '/maand',
      description: 'Voor loodgieters die starten met online zichtbaarheid',
      features: [
    ...
    },
    {
      ...
      price: '€1000',
      period: '/maand',
      description: 'Voor installatiebedrijven met groeiambitie',
      features: [
        'Alles uit Basis +',
    ...
    },
    {
      ...
      price: '€2000',
      period: '/maand',
      description: 'Voor installatiebedrijven die willen domineren',
      features: [
        'Alles uit Standaard +',
  ...
  const blogArticles = [
    {
      ...
      excerpt: 'Dezelfde principes gelden voor loodgieters en installateurs. Leer hoe je lokaal beter vindbaar wordt.',
    ...
    <>
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
            <div>
              <div className="mb-6 inline-flex items-center gap-2 border-4 border-black bg-accent px-4 py-2">
                ...
                <span className="text-base font-bold uppercase">Loodgieters & Installateurs</span>
              </div>
              ...
              <h1 className="mb-8 text-brutalist-hero leading-none text-black">
                ...
                <span className="relative inline-block">
                  ...
                  <span className="relative">loodgieters</span>
                </span>
                : word gevonden
              </h1>
            ...
            <div className="relative">
              <div className="relative border-4 border-black bg-accent p-2" style={{ boxShadow: '12px 12px 0 0 #000000, 0 25px 60px rgba(0, 0, 0, 0.3)' }}>
                <Image
                src="/images/loodgieter-seo.webp"
                  alt="SEO voor loodgieters en installatiebedrijven"
                  width={640}
                  height={427}
        ...
        <div className="relative mx-auto max-w-screen-2xl px-6">
          <div className="grid grid-cols-2 gap-8 lg:grid-cols-4">
            {[
              ...
              { value: '25+', label: 'Installateurs geholpen' },
        ...
        <div className="mx-auto max-w-screen-2xl px-6">
          <div className="mb-16">
            <p className="mb-6 text-base font-bold uppercase tracking-wider text-black/60 lg:text-lg">
              VOOR ALLE INSTALLATIE-SPECIALISATIES
            </p>
      ...
      <section className="relative border-b-4 border-black bg-accent py-24 lg:py-32">
        <div className="mx-auto max-w-screen-2xl px-6">
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-start">
            <div>
              <p className="mb-6 text-base font-bold uppercase tracking-wider text-black/60 lg:text-lg">
                WAAROM SEO VOOR INSTALLATIEBEDRIJVEN?
              </p>
              <h2 className="mb-8 text-brutalist-h1 text-black">
                Bereik klanten op het juiste moment
              </h2>
              <div className="h-1 w-32 bg-black mb-8"></div>
            </div>
            <div className="space-y-6">
              <p className="text-base font-bold text-black/80 lg:text-lg xl:text-xl">
                De installatiebranche is traditioneel afhankelijk van mond-tot-mondreclame en lokale bekendheid. Maar steeds meer mensen zoeken online naar een loodgieter of installateur. "Loodgieter spoed", "cv-ketel vervangen" of "warmtepomp installeren" zijn zoektermen met directe commerciële waarde.
              </p>
              <p className="text-base font-bold text-black/80 lg:text-lg xl:text-xl">
      ...
      <section className="relative border-b-4 border-black bg-white py-24 lg:py-32">
        <div className="mx-auto max-w-screen-2xl px-6">
          <div className="mb-16">
            ...
            <h2 className="mb-8 text-brutalist-h1 text-black">
              Complete SEO voor installateurs
            </h2>
            <p className="max-w-3xl text-base font-bold text-black/80 lg:text-lg xl:text-xl">
              Van technische optimalisatie tot lokale SEO en contentcreatie. We pakken alles aan wat nodig is om jouw installatiebedrijf beter vindbaar te maken.
            </p>
          </div>
      ...
      <section className="relative border-b-4 border-black bg-accent py-24 lg:py-32">
        <div className="mx-auto max-w-screen-2xl px-6">
          <div className="mb-16 text-center">
            ...
            <h2 className="mb-8 text-brutalist-h1 text-black">
              Pakketten voor installatiebedrijven
            </h2>
        ...
        <div className="mx-auto max-w-screen-2xl px-6">
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
            <div>
              ...
              <h2 className="mb-8 text-brutalist-h1 text-black">
                We kennen de installatiebranche
              </h2>
              <div className="h-1 w-32 bg-accent mb-8"></div>
              <p className="mb-8 text-base font-bold text-black/80 lg:text-lg xl:text-xl">
                Bij Vizibly werken we al jaren met vakmensen: loodgieters, elektriciens, cv-monteurs en allround installateurs. We begrijpen dat jouw business draait om betrouwbaarheid, snelle service en vakmanschap.
              </p>
              <p className="mb-8 text-base font-bold text-black/80 lg:text-lg xl:text-xl">
                Die kernwaarden vertalen we naar je online aanwezigheid. We focussen op wat telt: meer telefoontjes van serieuze klanten in jouw werkgebied.
              </p>
              <Button size="lg" asChild className="text-base px-8 py-5">
                <Link href="/contact">
                  START EEN GESPREK
      ...
      <section className="relative border-b-4 border-black bg-black py-24 text-white lg:py-32">
        ...
        <div className="relative mx-auto max-w-screen-2xl px-6">
          <div className="mb-16">
            <p className="mb-6 text-base font-bold uppercase tracking-wider text-accent lg:text-lg">
              KENNIS VOOR VAKMENSEN
            </p>
            <h2 className="mb-4 text-brutalist-h1 text-white">
              Artikelen over lokale SEO
            </h2>
          </div>
        ...
        <div className="mx-auto max-w-screen-2xl px-6">
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
            <div>
              ...
              <h2 className="mb-8 text-brutalist-h1 text-black">
                Vragen over SEO voor installateurs?
              </h2>
              <div className="h-1 w-32 bg-accent mb-8"></div>
            </div>
      ...
      <FinalCTA
        ...
        heading="Laat je installatiebedrijf groeien"
      />
