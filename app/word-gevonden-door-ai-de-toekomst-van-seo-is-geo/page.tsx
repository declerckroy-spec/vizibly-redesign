          ...
          <div className="mx-auto max-w-4xl text-center">
            <h2 className="text-brutalist-h1 mb-6 text-black">
              ...
              <span className="relative inline-block">
                ...
                <span className="relative text-accent">toekomst</span>
              </span>{" "}
              van zoeken?
            </h2>
            <p className="mb-10 text-lg font-bold text-black/80 lg:text-xl">
              Van SEO naar GEO. Van Google naar AI. Wij helpen je zichtbaar
              blijven op alle kanalen die ertoe doen.
            </p>
            <Button
              size="lg"
              asChild
