        ...
        <div className="mx-auto max-w-screen-2xl px-6">
          <div className="mx-auto max-w-4xl text-center">
            <h2 className="mb-8 text-brutalist-h1 text-black">
              Heb je een vraag die hier niet staat?
            </h2>
            <p className="mb-10 text-base font-bold text-black/80 lg:text-lg xl:text-xl">
              Neem contact op voor een vrijblijvende kennismaking. We beantwoorden graag al je vragen over SEO en hoe we jouw bedrijf kunnen helpen groeien.
            </p>
