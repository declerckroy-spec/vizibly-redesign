    ...
    <>
      ...
      <article className="relative border-b-4 border-black bg-white py-16 lg:py-24">
        <div className="mx-auto max-w-4xl px-6">
          ...
          <div className="mb-12 border-4 border-black bg-accent p-6 lg:p-8" style={{ boxShadow: '8px 8px 0 0 #000000' }}>
          ...
          <div className="mb-12 border-4 border-black bg-black p-6 lg:p-8 text-white" style={{ boxShadow: '8px 8px 0 0 #CCFF00' }}>
